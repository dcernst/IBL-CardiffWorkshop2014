...
\begin{itemize}
%\item Comparing IBL vs non-IBL university mathematics courses.
...
\begin{center}
\tikzstyle{block} = [rectangle, draw, fill=blue!20, text width=4em, text centered, rounded corners, minimum height=2.5em]
\tikzstyle{line} = [draw, thick, stealth-]
\begin{tikzpicture}[scale=.9]%[auto]%node distance = 2.5cm
